...
timerObj.toc()
#Elapsed time is 29.085737 seconds.


####Test set #Run only once. 
#timerObj.tic()
#module1OutStorage_test = pixelHop2TransBatchProcessor(pre_X_test,loaded_pixelHop2_6000) #
#timerObj.toc()
...
print("feature selection is done for train and test::")#Elapsed time is 871.240637 seconds.
timerObj.toc()
...
print("LAG is done for train set:")#Elapsed time is 0.013641 seconds.
timerObj.toc()

timerObj.tic()
finalFeature_unit1_test = lag_unit1.transform(reducedFeatureImgs_unit1_test)
print("LAG is done for test set:")#Elapsed time is 0.092190 seconds.
timerObj.toc()
...
print("feature selection is done for train and test:") #Elapsed time is 748.951350 seconds.
timerObj.toc()
...
print("LAG is done for train set:")#Elapsed time is 0.014913 seconds.
timerObj.toc()

timerObj.tic()
finalFeature_unit2_test = lag_unit2.transform(reducedFeatureImgs_unit2_test)
print("LAG is done for test set:")#Elapsed time is 0.073395 seconds.
timerObj.toc()
