...
print("transform is done for train for unit1:")#Elapsed time is 484.945213 seconds.
timerObj.toc()


timerObj.tic()
module1Out2_train = pixelHop2TransBatchProcessor_Unit2_V2(subXTrain4,loaded_pixelHop2_6000)
print("transform is done for train for unit2:")#Elapsed time is 411.174275 seconds.
timerObj.toc()

timerObj.tic()
module1Out3_train = pixelHop2TransBatchProcessor_Unit3_V2(subXTrain4,loaded_pixelHop2_6000)
print("transform is done for train for unit3:")#Elapsed time is 299.427657 seconds.
timerObj.toc()
...
print("feature selection is done for train and test::")#Elapsed time is 1414.248872 seconds.
timerObj.toc()
...
print("LAG is done for train set:")#Elapsed time is 0.476045 seconds.
timerObj.toc()

timerObj.tic()
finalFeature_unit1_test = lag_unit1.transform(reducedFeatureImgs_unit1_test)
print("LAG is done for test set:")#Elapsed time is 0.268972 seconds.
timerObj.toc()
...
print("feature selection is done for train and test:") #Elapsed time is 1313.008062 seconds.
timerObj.toc()
...
print("feature selection is done for train and test:") #Elapsed time is 98.041291 seconds.
timerObj.toc()
...
file = open('finalExtractedFeatures20000.pckl', 'rb')
finalFeature_train_ex, subYTrain4_ex, finalFeature_test_ex = pickle.load(file)
file.close()

print(finalFeature_train_ex.shape)
print(subYTrain4_ex.shape)
print(finalFeature_test_ex.shape)

#trianing with Cross vaildation 
timerObj.tic()
final_num_of_estimators, max_stor_ave_acc_RF , fin_accuracy_on_train_RF , fin_accuracy_on_test_RF , fin_RF_clf, fin_predicted_label_on_test_data_RF = randomForestExecuter(finalFeature_train_ex, subYTrain4_ex, finalFeature_test_ex, Y_test)
timerObj.toc()
...
accuracies = [(1-0.7984),  (1-0.838), (1-0.602), (1-0.4608),  0.5967]
