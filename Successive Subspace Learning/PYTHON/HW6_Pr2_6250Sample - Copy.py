...
print("transform is done for train:")#Elapsed time is 387.874339 seconds.
timerObj.toc()
...
print("feature selection is done for train and test::")#Elapsed time is 835.263727 seconds.
timerObj.toc()
...
print("LAG is done for train set:")#Elapsed time is 0.141567 seconds.
timerObj.toc()

timerObj.tic()
finalFeature_unit1_test = lag_unit1.transform(reducedFeatureImgs_unit1_test)
print("LAG is done for test set:")#Elapsed time is 0.237510 seconds.
timerObj.toc()
...
print("feature selection is done for train and test:") #Elapsed time is 684.777921 seconds.
timerObj.toc()
...
print("LAG is done for train set:")#Elapsed time is 0.115439 seconds.
timerObj.toc()

timerObj.tic()
finalFeature_unit2_test = lag_unit2.transform(reducedFeatureImgs_unit2_test)
print("LAG is done for test set:")#Elapsed time is 0.194828 seconds.
timerObj.toc()
...
print("feature selection is done for train and test:") #Elapsed time is 52.255307 seconds.
timerObj.toc()
...
print("LAG is done for train set:") #Elapsed time is 54.440326 seconds.
timerObj.toc()

timerObj.tic()
finalFeature_unit3_test = lag_unit3.transform(reducedFeatureImgs_unit3_test)
print("LAG is done for test set:") #Elapsed time is 0.017998 seconds.
timerObj.toc()
