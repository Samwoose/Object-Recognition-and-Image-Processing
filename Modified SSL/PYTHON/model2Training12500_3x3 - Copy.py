...
print("transform is done for train for unit1:")#Elapsed time is 191.695747 seconds.
timerObj.toc()
...
print("transform is done for train for unit2:")#Elapsed time is 203.135884 seconds..
timerObj.toc()
...
print("transform is done for train for unit3:")#Elapsed time is 176.122547 seconds.
timerObj.toc()
...
#transform test samples by pixelHop2_6250_5x5
#Seperate extracted features from each hop
timerObj.tic()
module1Out1_test = pixelHop2TransBatchProcessor_Unit1_V2(pre_X_test,loaded_pixelHop2_6250)
print("transform is done for train for unit1:")#Elapsed time is 81.485726 seconds..
timerObj.toc()
...
print("transform is done for train for unit1:")#Elapsed time is 82.509172 seconds.
timerObj.toc()
...
print("transform is done for train for unit1:")#Elapsed time is 83.789296 seconds.
timerObj.toc()
...
print("feature selection is done for train and test::")#Elapsed time is 99.167789 seconds.
timerObj.toc()
...
print("feature selection is done for train and test:") #Elapsed time is 242.149453 seconds.
timerObj.toc()
#LAG Unit
...
reducedFeatureImgs_unit3_train.shape
...
f = open('finalFeature_train12500_3x3', 'wb')
...
f = open('finalFeature_test12500_3x3', 'wb')
