...
file = open('finalFeature_train6250_3x3', 'rb')
finalFeature_train_model1 = pickle.load(file)
file.close()


file = open('finalFeature_train6250_5x5', 'rb')
...
file = open('finalFeature_test6250_3x3', 'rb')
finalFeature_test_model1 = pickle.load(file)
file.close()


file = open('finalFeature_test6250_5x5', 'rb')
...
exclf = RandomForestClassifier(n_estimators = 500, bootstrap=True)
exclf.fit(finalFeature_train, YTrain6250)
