...
f.close()
f = open('Train3125.pckl', 'rb')
XTrain3125, YTrain3125 = pickle.load(f)
f.close()
...
subXTrain4=XTrain3125
subYTrain4 =YTrain3125
...
f = open('finalFeature_train3125_3x3', 'wb')
...
f = open('finalFeature_test3125_3x3', 'wb')
