...
file = open('finalFeature_train3125_3x3', 'rb')
finalFeature_train_model1 = pickle.load(file)
file.close()


file = open('finalFeature_train3125_5x5', 'rb')
...
file = open('finalFeature_test3125_3x3', 'rb')
finalFeature_test_model1 = pickle.load(file)
file.close()


file = open('finalFeature_test3125_5x5', 'rb')
...
exclf.fit(finalFeature_train, YTrain3125)
