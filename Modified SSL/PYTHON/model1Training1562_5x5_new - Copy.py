...
def featureSelector(X,Y):
    ...
    numOfNs = int(sortedIndex.shape[0]/1.25) #select 80 persent of lowest values
...
f = open('module1Out1_train1562_5x5', 'rb')
module1Out1_train = pickle.load(f)
f.close()
f = open('module1Out2_train1562_5x5', 'rb')
module1Out2_train = pickle.load(f)
f.close()
f = open('module1Out3_train1562_5x5', 'rb')
...
f = open('module1Out1_test1562_5x5', 'rb')
module1Out1_test = pickle.load(f)
f.close()
f = open('module1Out2_test1562_5x5', 'rb')
module1Out2_test = pickle.load(f)
f.close()
f = open('module1Out3_test1562_5x5', 'rb')
...
f = open('finalFeature_train1562_5x5_new', 'wb')
...
f = open('finalFeature_test1562_5x5_new', 'wb')
