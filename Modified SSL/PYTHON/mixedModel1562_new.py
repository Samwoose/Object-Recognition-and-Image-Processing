...
file = open('finalFeature_train1562_3x3_new', 'rb')
finalFeature_train_model1 = pickle.load(file)
file.close()


file = open('finalFeature_train1562_5x5_new', 'rb')
...
file = open('finalFeature_test1562_3x3_new', 'rb')
finalFeature_test_model1 = pickle.load(file)
file.close()


file = open('finalFeature_test1562_5x5_new', 'rb')
...
exclf.fit(finalFeature_train, YTrain1562)
