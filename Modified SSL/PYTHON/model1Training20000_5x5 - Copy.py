...
print("transform is done for train for unit1:")#Elapsed time is 475.617917 seconds.
timerObj.toc()
...
#Pretrained outputs from module1
#train
module1Out1_train =
module1Out2_train =
module1Out3_train =
...
#Save firtst
f = open('finalFeature_train_5x5', 'wb')
pickle.dump(finalFeature_train, f)
f.close()

f = open('finalFeature_test_5x5', 'wb')
